...
/**
 * Servlet di creazione grafici a barre verticali cumulative
 */
public class StackedVerticalBarChartServlet extends HttpServlet {
	/**
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// rimuove dalla audienceList l'audience Total non necessaria in qusto tipo di grafico
		audienceList.remove("Total");
		...
		//plot.barWidth = 30;
		plot.cumulative = true; // cumula le barre
