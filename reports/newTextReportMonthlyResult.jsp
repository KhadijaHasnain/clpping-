				...
				<TR>
					<TD>
						...
						<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<TR><TD>&nbsp;</TD></TR>
							<TR>
								<TD class="text_13_blu" style="text-align:center;"><B>Monthly Report</B></TD>
							</TR>
							<TR><TD>&nbsp;</TD></TR>
							<TR>
								<TD>
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="3" align="center" class="table_records">
										...
										<%for(int i = yearFrom; i <= yearTo; i++) {%>
											<%for(int j = contatoreMeseFrom; j<=contatoreMeseTo; j++) {
												if( (i==yearFrom && j >= monthFrom) || (i==yearTo && j <=monthTo) || (i!=yearFrom && i != yearTo) ) {
											%>
											<TD class="td_table_title"><%=Utils.getMonthDescription(j)%></TD>
											<%	}
											}%>
										<%}%>
										<%for(int i = yearFrom; i <= yearTo; i++) {%>
										...
										<TR>
											...
											if( (i==yearFrom && j >= monthFrom) || (i==yearTo && j <=monthTo) || (i!=yearFrom && i != yearTo) ) {
											%>
											<TD class="<%=styleClass%>"><B><%=(monthScoreTotal.get(i + "_" + j)==null)?"":monthScoreTotal.get(i + "_" + j)%></B></TD>
											<%	}
											}%>
											<%}%>
											<%for(int i = yearFrom; i <= yearTo; i++) {%>
								...
								<TD>
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="3" align="center" class="table_records">
										...
										<TR>
											...
											if( (i==yearFrom && j >= monthFrom) || (i==yearTo && j <=monthTo) || (i!=yearFrom && i != yearTo) ) {
											%>
											<TD class="<%=styleClass%>"><B><%=(monthCountTotal.get(i + "_" + j)==null)?"":monthCountTotal.get(i + "_" + j)%></B></TD>
											<%	}
											}%>
											<%}%>
											<%for(int i = yearFrom; i <= yearTo; i++) {%>
