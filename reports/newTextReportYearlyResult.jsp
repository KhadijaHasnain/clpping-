				...
				<TR>
					<TD>
						...
						<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<TR><TD>&nbsp;</TD></TR>
							<TR>
								<TD class="text_13_blu" style="text-align:center;"><B>Yearly Report</B></TD>
							</TR>
							<TR><TD>&nbsp;</TD></TR>
							<TR>
								<TD>
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="3" align="center" class="table_records">
										...
										<TR>
											...
											%>
											<TD class="<%=styleClass%>"><B><%=score%></B></TD>
											<%}%>
										</TR>
										<%}
										String styleClass = (k%2 > 0)?"td_record_table1":"td_record_table2";
										...
										<TR>
											...
											<%for(int i = yearFrom; i <= yearTo; i++) {%>
											<TD class="<%=styleClass%>"><B><%=(yearScoreTotal.get(i+"")==null)?"":yearScoreTotal.get(i+"")%></B></TD>
											<%}%>
											<%for(int i = yearFrom; i <= yearTo; i++) {%>
								...
								<TD>
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="3" align="center" class="table_records">
										...
										<TR>
											...
											%>
											<TD class="<%=styleClass%>"><B><%=count%></B></TD>
											<%}%>
										</TR>
										<%}
										styleClass = (k%2 > 0)?"td_record_table1":"td_record_table2";
										...
										<TR>
											<TD class="<%=styleClass%>"><B>TOTAL</B></TD>
											<%for(int i = yearFrom; i <= yearTo; i++) {%>
											<TD class="<%=styleClass%>"><B><%=(yearCountTotal.get(i+"")==null)?"":yearCountTotal.get(i+"")%></B></TD>
											<%}%>
											<%for(int i = yearFrom; i <= yearTo; i++) {%>
											<TD class="<%=styleClass%>">&nbsp;</TD>
											<%}%>
