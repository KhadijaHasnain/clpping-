	...
	<TR>
		<TD>
			<TABLE cellpadding="0" cellspacing="15" border="0" width="100%">
				...
				<TR>
					<TD>
						<FORM name="search_form" action="<%=request.getContextPath()%>/products/searchResultPopup.jsp" method="POST">
						<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<TD>
									<TABLE width="70%" border="0" cellspacing="0" cellpadding="6" align="center">
										...
										<TR>
											...
											<TD><INPUT type="text" name="partnumberorname_search" value="<%=Utils.formatStringForView(partnumberorname_search)%>" class="input_text" maxlength="50"></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
							...
							<TR>
								<TD style="text-align:center;">
									<INPUT type="button" name="submit_form_button" value="Search Product" onclick="javascript:submitForm()" class="button">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
