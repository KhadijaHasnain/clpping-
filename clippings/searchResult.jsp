...
Vector resultVector = DbUtils.getSearchClippings(area_id_search, country_id_search, publication_id_search, audience_id_search, title_search, fieldstory_id_search, datepublished_from_search, datepublished_to_search, lengthofarticle_id_search, tone_id_search, graphic_id_search, cover_id_search, score_search, ordering, user);
