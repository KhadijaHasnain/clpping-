...
<jsp:useBean id="divisionBean" class="it.vidiemme.clipping.beans.DivisionBean" scope="request"/>
<jsp:setProperty name="divisionBean" property="*"/>
...
if(id_area.equals(""))
	id_area = divisionBean.getArea_id();
	...
	<TR>
		<TD class="td_content">
			<TABLE cellpadding="0" cellspacing="15" border="0" width="100%">
				...
				<TR>
					<TD class="text_13_blu"><B>DIVISIONS - ADD DIVISION</B></TD>
				</TR>
				<TR>
					<TD>
						<FORM name="insert_form" action="<%=request.getContextPath()%>/manageDivision.do" method="POST">
