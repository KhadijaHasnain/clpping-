...
<HEAD>
	...
	<SCRIPT language="javascript">
		...
		function goToInsert(){
			document.location.href="<%=request.getContextPath()%>/divisions/insert.jsp";
		}
						...
						<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<TD>
									<TABLE width="70%" border="0" cellspacing="0" cellpadding="6" align="center">
										...
										<TR>
											...
											<TD><INPUT type="text" name="name_search" value="<%=Utils.formatStringForView(name_search)%>" class="input_text" maxlength="60"></TD>
										</TR>
										<TR>
							...
							<TR>
								<TD style="text-align:center;">
									<INPUT type="button" name="submit_form_button" value="Search Divisions" onclick="javascript:startSearch()" class="button">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<INPUT type="button" name="reset_form_button" value="Reset" onclick="javascript:resetForm()" class="button">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<INPUT type="button" name="enter_division_button" value="Enter Division" onclick="javascript:goToInsert()" class="button">
								</TD>
							</TR>
						</TABLE>
						</FORM>
