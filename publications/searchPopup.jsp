...
String countryDesc = DbUtils.getCountryDescription(country_id_search);
%>
							...
							<TR>
								<TD>
									<TABLE width="70%" border="0" cellspacing="0" cellpadding="6" align="center">
										...
										<%if(!country_id_search.equals("")){%>
										<TR>
											<TD class="text_12_black"><B>Country</B></TD>
											<TD class="text_12_black"><INPUT type="hidden" name="country_id_search" value="<%=country_id_search%>" class="input_text"><%=countryDesc%></TD>
										</TR>
										<%}%>
										<TR>
