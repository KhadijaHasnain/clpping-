...
<HEAD>
	...
	<SCRIPT language="javascript">
		...
		function reloadForm(){
			document.insert_form.action="<%=request.getContextPath()%>/publications/insert.jsp";
			submitForm();
		}
		function setFocus(){
		...
		function goToSearch(){
			document.location.href="<%=request.getContextPath()%>/publications/search.jsp";
		}
		function resetForm(){
			<%if(user.getId_role().equals(Constants.idRoleAdmin) || (user.getId_role().equals(Constants.idRoleManager) && user.getAreas().size() > 1)){%>
						...
						<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<TR>
								<TD style="text-align:center;">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<INPUT type="button" name="search_publication_button" value="Search Publication" onclick="javascript:goToSearch()" class="button">
								</TD>
							</TR>
						</TABLE>
						</FORM>
